...
export function TimePickerOption({ seconds }: { seconds: number }) {
  ...
  return (
    <div>
        <button onClick={onPress} className="h-full w-full p-6 flex text-center text-3xl bg-gray-200 dark:bg-slate-700 rounded-2xl shadow-lg border-slate-300 dark:border-slate-800 border-2">
